  ...
  return (
    <div>
     <form onSubmit={(e)=>{e.preventDefault()}}>
       ...
       <input className="w-72 border border-gray-400 mt-1 px-2 py-1 rounded-md"type="text" placeholder="John Wick"/>
      ...
      <div>
       <button className="w-72 border bg-black border-gray-300 mt-4 hover:bg-opacity-55 px-2 py-1 rounded-md text-white">SignUp</button>
       </div>
